...
class UniversalDatabase {
  ...
  /**
   * Adding multiple items to daabase collection
   * @param collection name of collection
   * @param data object to store
   * @returns result of operation
   */
  static async addMany<T>(
    ...
    try {
      ...
      const result = await col?.insertMany(newData);
  ...
  static async findOne<T extends keyof Entities>(
    ...
    try {
      ...
      const res = await col?.findOne(finder, options);
  ...
  static async findMany<T extends keyof Entities>(
    ...
    try {
      ...
      const res = col?.find(query, options);
  ...
  static async findOneAndDelete<T extends keyof Entities>(
    ...
    try {
      ...
      const res = (await col?.findOneAndDelete(finder, options)) as
